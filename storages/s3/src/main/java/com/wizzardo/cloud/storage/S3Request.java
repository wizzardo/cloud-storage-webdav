...
import com.wizzardo.tools.http.Body;
...
//                .header("x-amz-storage-class", "REDUCED_REDUNDANCY")
    ...
    protected String encode(String value) {
        return Unchecked.call(() -> URLEncoder.encode(value, StandardCharsets.UTF_8));
    }
    ...
    public S3Request path(String path) {
    ...
    public S3Request region(String region) {
        this.region = region;
        return self();
    }

    public S3Request host(String host) {
        this.host = host;
        return self();
    }

    public S3Request bucket(String bucket) {
        this.bucket = "/" + bucket;
        return self();
    }

    public S3Request keyId(String keyId) {
        this.keyId = keyId;
        return self();
    }

    public S3Request secret(String secret) {
        this.secret = secret;
        return self();
    }

    @Override
    protected S3Request self() {
        return this;
    }
